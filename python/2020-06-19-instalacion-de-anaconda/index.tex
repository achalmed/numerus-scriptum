...
\item
  ...
  proyecto
\item
  \textbf{Múltiples Entornos:} Ideal para mis 10+ blogs con dependencias
  diferentes
\item
...
\subsection{2. Desinstalar Instalaciones
Previas}\label{desinstalar-instalaciones-previas}
...
\subsection{Método 1: Instalación
Rápida}\label{muxe9todo-1-instalaciuxf3n-ruxe1pida}
...
\CommentTok{\# O solo para fish}

\ExtensionTok{conda}\NormalTok{ init fish}
