...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Variable que indica uso interno}
\NormalTok{\_dato\_temporal }\OperatorTok{=} \DecValTok{100}
\NormalTok{\_calculo\_intermedio }\OperatorTok{=}\NormalTok{ precio }\OperatorTok{*}\NormalTok{ cantidad}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{area\_bajo\_lorenz }\OperatorTok{=}\NormalTok{ (}\FloatTok{0.2} \OperatorTok{*}\NormalTok{ prop\_1) }\OperatorTok{+} \OperatorTok{\textbackslash{}}
\NormalTok{                   (}\FloatTok{0.2} \OperatorTok{*}\NormalTok{ (prop\_1 }\OperatorTok{+}\NormalTok{ prop\_2)) }\OperatorTok{/} \DecValTok{2} \OperatorTok{+} \OperatorTok{\textbackslash{}}
\NormalTok{                   (}\FloatTok{0.2} \OperatorTok{*}\NormalTok{ (prop\_2 }\OperatorTok{+}\NormalTok{ prop\_3)) }\OperatorTok{/} \DecValTok{2} \OperatorTok{+} \OperatorTok{\textbackslash{}}
\NormalTok{                   (}\FloatTok{0.2} \OperatorTok{*}\NormalTok{ (prop\_3 }\OperatorTok{+}\NormalTok{ prop\_4)) }\OperatorTok{/} \DecValTok{2} \OperatorTok{+} \OperatorTok{\textbackslash{}}
\NormalTok{                   (}\FloatTok{0.2} \OperatorTok{*}\NormalTok{ (prop\_4 }\OperatorTok{+}\NormalTok{ prop\_5)) }\OperatorTok{/} \DecValTok{2}
...
\NormalTok{    margen\_contribucion\_porcentaje }\OperatorTok{=}\NormalTok{ (margen\_contribucion\_unitario }\OperatorTok{/}\NormalTok{ precio\_venta\_unitario) }\OperatorTok{*} \DecValTok{100}
...
\NormalTok{        perdida }\OperatorTok{=}\NormalTok{ diferencia }\OperatorTok{*}\NormalTok{ margen\_contribucion\_unitario}
    ...
    \ControlFlowTok{else}\NormalTok{:}
        \BuiltInTok{print}\NormalTok{(}\StringTok{"La empresa estaría en el punto de equilibrio (sin ganancias ni pérdidas)."}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
