...
\title{Organización de objetos en LibreOffice}


\shorttitle{Organización de objetos en LibreOffice}
...
\hypersetup{
  pdftitle={Organizaci\'{o}n de objetos en LibreOffice},
  pdfauthor={Autor}
}
\makeatletter
...
\tableofcontents
\newpage
\section[Introduction]{Organización de objetos en LibreOffice}
