...
\title{Conceptos esenciales antes de usar R}


\shorttitle{Conceptos esenciales antes de usar R}
...
\tableofcontents
\newpage
\section[Introduction]{Conceptos esenciales antes de usar R}
...
\begin{tcolorbox}[enhanced jigsaw, leftrule=.75mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, titlerule=0mm, breakable, opacitybacktitle=0.6, rightrule=.15mm, bottomrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, toptitle=1mm, arc=.35mm, opacityback=0, colback=white, left=2mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}]
