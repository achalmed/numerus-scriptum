...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colframe=quarto-callout-note-color-frame, arc=.35mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Nota}, titlerule=0mm, toptitle=1mm, opacitybacktitle=0.6, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, left=2mm, colbacktitle=quarto-callout-note-color!10!white, coltitle=black, opacityback=0]
