...
\usepackage{hyperref}
\hypersetup{
  pdftitle={Guía completa de instalación de R y RStudio Desktop},
...
\section{Guía completa de instalación de R y RStudio
Desktop}\label{guuxeda-completa-de-instalaciuxf3n-de-r-y-rstudio-desktop}
...
\tightlist
\item
  \hyperref[1-conceptos-previos]{Conceptos previos}
\item
  \hyperref[2-instalaciuxf3n-de-r-en-kubuntu--ubuntu]{Instalación de R
  en Kubuntu / Ubuntu}
\item
  \hyperref[3-instalaciuxf3n-de-r-en-arch-linux]{Instalación de R en
  Arch Linux}
\item
  \hyperref[4-instalaciuxf3n-de-r-en-windows]{Instalación de R en
  Windows}
\item
  \hyperref[5-instalaciuxf3n-de-rstudio-desktop-en-kubuntu--ubuntu]{Instalación
  de RStudio Desktop en Kubuntu / Ubuntu}
\item
  \hyperref[6-instalaciuxf3n-de-rstudio-desktop-en-arch-linux]{Instalación
  de RStudio Desktop en Arch Linux}
\item
  \hyperref[7-instalaciuxf3n-de-rstudio-desktop-en-windows]{Instalación
  de RStudio Desktop en Windows}
\item
  \hyperref[8-verificaciuxf3n-post-instalaciuxf3n]{Verificación
  post-instalación}
\item
  \hyperref[9-dependencias-de-sistema-para-paquetes-de-r-linux]{Dependencias
  de sistema para paquetes de R (Linux)}
\item
  \hyperref[10-gestiuxf3n-de-paquetes-de-r]{Gestión de paquetes de R}
\item
  \hyperref[11-actualizaciuxf3n-y-desinstalaciuxf3n]{Actualización y
  desinstalación}
\item
  \hyperref[12-soluciuxf3n-de-problemas-comunes]{Solución de problemas
  comunes}
\item
  \hyperref[13-referencias-oficiales]{Referencias oficiales}
\end{enumerate}

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\subsection{1. Conceptos previos}\label{conceptos-previos}

\subsubsection{1.1. R vs.~RStudio}\label{r-vs.-rstudio}
...
\subsubsection{1.2. Orden de instalación
...
\subsubsection{1.3. Compatibilidad de plataformas (RStudio
...
\subsection{2. Instalación de R en Kubuntu /
...
\subsubsection{2.1. Opción A --- Repositorio de Ubuntu (rápida, versión
potencialmente
...
\subsubsection{2.2. Opción B --- Repositorio oficial de CRAN
...
\subsubsection{2.3. Nota sobre versiones de Ubuntu
...
\subsubsection{\texorpdfstring{2.4. Instalación masiva de paquetes CRAN
como binarios
...
\subsection{3. Instalación de R en Arch
...
\subsubsection{3.1. Instalación con
...
\subsubsection{3.2. Estructura de bibliotecas de paquetes en
...
\subsubsection{3.3. Paquetes de R adicionales vía
...
\subsubsection{3.4. Instalación de paquetes CRAN desde dentro de
...
\subsubsection{3.5. Repositorios de terceros para binarios precompilados
...
\subsection{4. Instalación de R en
Windows}\label{instalaciuxf3n-de-r-en-windows}

\subsubsection{4.1. Descarga desde CRAN}\label{descarga-desde-cran}
...
\subsubsection{4.2. Pasos del instalador}\label{pasos-del-instalador}
...
\subsubsection{4.3. Verificación}\label{verificaciuxf3n}
...
\subsubsection{4.4. Rtools (opcional pero
...
\subsection{5. Instalación de RStudio Desktop en Kubuntu /
...
\subsubsection{\texorpdfstring{5.1. Descarga del paquete
...
\subsubsection{\texorpdfstring{5.2. Instalación del paquete
...
\subsubsection{5.3. Verificación de la firma del paquete (opcional,
...
\subsubsection{5.4. Distribuciones
...
\subsection{6. Instalación de RStudio Desktop en Arch
...
\subsubsection{6.1. Opciones disponibles en
...
\subsubsection{6.2. Instalación con un ayudante de AUR
...
\subsubsection{6.3. Instalación manual desde AUR (sin
...
\subsubsection{6.4. Notas importantes para Arch /
...
\subsection{7. Instalación de RStudio Desktop en
...
\subsubsection{7.1. Descarga}\label{descarga}
...
\subsubsection{7.2. Instalación}\label{instalaciuxf3n}
...
\subsubsection{7.3. Alternativa portable
...
\subsection{8. Verificación
post-instalación}\label{verificaciuxf3n-post-instalaciuxf3n}

\subsubsection{8.1. Verificar R desde terminal (Linux y
...
\subsubsection{8.2. Verificar R desde su propia consola
...
\subsubsection{8.3. Verificar que RStudio detecta
...
\subsection{9. Dependencias de sistema para paquetes de R
...
\subsubsection{9.1. Ejemplo para Ubuntu /
...
\subsubsection{9.2. Ejemplo para Arch
Linux}\label{ejemplo-para-arch-linux}
...
\subsubsection{9.3. Detección automática de
...
\subsection{10. Gestión de paquetes de
R}\label{gestiuxf3n-de-paquetes-de-r}

\subsubsection{10.1. Instalar paquetes desde
...
\subsubsection{10.2. Cargar un paquete
...
\subsubsection{10.3. Actualizar todos los paquetes
...
\subsubsection{10.4. Ver la biblioteca de paquetes
...
\subsubsection{\texorpdfstring{10.5. Instalar paquetes desde GitHub
...
\subsection{11. Actualización y
desinstalación}\label{actualizaciuxf3n-y-desinstalaciuxf3n}

\subsubsection{11.1. Actualizar R en Kubuntu/Ubuntu (repositorio
...
\subsubsection{11.2. Actualizar R en Arch
...
\subsubsection{11.3. Actualizar RStudio
...
\subsubsection{11.4. Desinstalación}\label{desinstalaciuxf3n}
...
\subsection{12. Solución de problemas
...
\subsubsection{12.2. Error de clave GPG no válida al añadir el
repositorio
...
\subsubsection{12.3. RStudio no detecta R recién instalado
...
\subsubsection{12.4. Falla la compilación de un paquete de R por falta
de una librería de sistema
...
\subsubsection{\texorpdfstring{12.5. El paquete \texttt{rstudio-desktop}
de AUR no compila tras una actualización del sistema
...
\subsubsection{\texorpdfstring{12.6. En Windows, \texttt{R} no es
reconocido como
...
\subsection{13. Referencias oficiales}\label{referencias-oficiales}
...
\item
  ...
  Instalacion De R}
\item
  \href{https://numerus-scriptum.netlify.app/r/2020-06-10-012-que-ofrece-r/index.pdf}{\faIcon{file-pdf}}
  \href{https://numerus-scriptum.netlify.app/r/2020-06-10-012-que-ofrece-r}{012
  Que Ofrece R}
\item
